...
const Footer = () => {
  return (
    <div className="border-b border-neutral-900">
      ...
      <div className="  mb-8 flex flex-wrap lg:justify-center p-0">
        <motion.div
          ...
          className="lg:border-r border-neutral-500 w-full lg:w-1/2 flex justify-block">
            ...
            <span className="m-auto lg:text-2xl text-neutral-350">Shyam Singh<br/>India<br/>shyamsingh841442@gmail.com</span>
        ...
        >
            ...
            <form target="_blank" action="https://formsubmit.co/shyamsingh841442@gmail.com" method="POST">
      ...
      <span className="pb-5 mt-auto text-xs">Copyright &#169; 2024 by Shyam Singh - All Rights Reserved.</span>
    </div>
  );
};
